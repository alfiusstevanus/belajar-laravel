...
<div class="row justify-content-center">
    <div class="col-md-4">   
        ...
        <div class="alert alert-success alert-dismissible fade show mt-5 mb-2" role="alert">
            {{ session('success') }}
        ...
        <div class="alert alert-danger alert-dismissible fade show mt-5 mb-2" role="alert">
            {{ session('loginError') }}
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        @endif
